...
const pages = [{id:1, name:'Ecovillage', url:'/santaclara/ecovillage'},{ id:2, name:'Playaviva', url:'/santaclara/playaviva'},{ id:3, name:'Ubicaciones', url:'/santaclara/ubicaciones'},{ id:4, name:'Ver Disponibilidad', url:'/cita/registro'}, { id:5, name:'Brochure', url:'/brochure/pdf'}];
